# AeroPulse (MacOSNetworkFanSpeed)
...
- **Privileged Helper**: No longer required. AeroPulse operates entirely in user-space for enhanced security and simplified installation.
