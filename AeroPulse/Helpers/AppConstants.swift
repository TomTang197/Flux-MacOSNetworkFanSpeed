...
struct AppStrings {
    ...
    static let powerUsage = "Total Power"
    static let chargingPower = "Charging Power"
    ...
    static let quitApplication = "Quit AeroPulse"
    static let bugFeedback = "Bug Feedback"
    static let bugFeedbackDescription = "Report issues or suggestions"
    static let bugFeedbackOpen = "Open Feedback Form"
    static let bugFeedbackEmailLabel = "Recipient"
    static let bugFeedbackTitle = "Title"
    static let bugFeedbackTitlePlaceholder = "Short summary"
    static let bugFeedbackDetails = "Details"
    static let bugFeedbackDetailsPlaceholder =
        "What happened? How can we reproduce it? What did you expect?"
    static let bugFeedbackContact = "Contact (optional)"
    static let bugFeedbackContactPlaceholder = "Email / Telegram / WeChat"
